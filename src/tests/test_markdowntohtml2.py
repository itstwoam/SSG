...
This is another paragraph with _italic_ text and `code` here
    ...
    """
        ...
        #     print(f"--- Top-level Child {i} ---")
        #     print(f"Tag: {getattr(child, 'tag', None)}")
        #     print(f"Value: {getattr(child, 'value', None)}")
        #     print(f"HTML: {child.to_html()}")
        html = node.to_html()
        #print(f'HTML node is of type: {type(node)}')
        self.assertEqual(
            html,
